  ...
  Future<bool> onWillPop() async {
    if (widget.note != null) {
      ...
      if (_titleController.text == "" &&
          ...
          widget.note!.reminderTime == _reminderTime &&
          _color == widget.note!.color) {
        Navigator.pop(context);
        // some modifications
      } else if (_titleController.text != widget.note!.title ||
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Row(children: [
        ...
        if (widget.note != null)
          MyButton(
              tooltip:
                  appProvider.isArchiveMode ? "Unarchive note" : "Archive note",
