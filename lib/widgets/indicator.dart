                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Center(child: appProvider.isArchiveMode ? const Text("Release to open normal page", style: TextStyle(fontSize: 20)) : Text("Release to open archive page", style: TextStyle(fontSize: 20)))
                          ]
                        ),
                      ),
                    ),
